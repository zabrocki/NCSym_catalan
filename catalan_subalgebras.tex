...
It is the case even if the initial value of the sequence is ignored or replaced by a $1$,
$\phi_{h,a}$ applied to these sequences also contain negative entries and the modified
sequences also cannot be a dimension sequence of an \FGCCHA.
\end{example}
