...
Inside the set of all noncrossing partitions, the Catalan numbers enumerate several distinguished subsets including the nonnesting and noncrossing set partitions.  
We recognize that some of the bases had product and coproduct formulas which were closed if we restricted to the nonnesting or noncrossing subsets.  
