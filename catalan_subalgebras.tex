...
See Example \ref{ex:balancedLyndon} for an explanation of why this is equal to sequence \cite[A022553]{OEIS}
...
Lyndon words = number of Lyndon words in a Dyck paths that don't touch the diagonal
\end{example}
