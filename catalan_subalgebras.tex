...
Then the sequence $\vec{a} = \phi_{h, a}(\vec{h})$ belongs to the domain
since by Proposition~\ref{prop:SequencesAsHopfStructures},
$\vec{a}$ is the graded cardinality of its free generating set.  
