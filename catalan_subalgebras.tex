...
These are well known and exposition of similar results can be found in~\cite[Chapter 5]{Reutenauer-FreeLieAlgebras},~\cite{KK95}, among others.  
However, the exact statement of Proposition~\ref{prop:sequences} does not appear in these sources, so we include a proof for the sake of completeness.
