...
However, we have not found it recorded elsewhere in the literature, and in doing so~\cite{AT22} generalize a recurrent approach to comparing Hopf algebras; see Example~\ref{example:hopf_algebras_of_permutations}.
...
Let $H$ be an \FGCCHA.  
In this section we construct all the isomorphism classes of \FGCCHA which occur as Hopf subalgebras of $H$.
