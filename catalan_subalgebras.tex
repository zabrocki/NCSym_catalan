...
{\color{orange}{The relationship between $\mathcal{U}(L)$ and $\mathcal{P}$ is further determined by the Poincar\'{e}--Birkhoff--Witt Theorem and the Poincar\'{e}--Birkhoff--Witt Theorem.  We state each as they appear in~\cite[Theorem 4.1.3]{L08}, but we refer the reader to~\cite[{\color{red} missing ref!}]{Cartier57} and~\cite[Theorem 5.18]{MM65} for original statements.}}
