...
This sort of result is well-known to experts and sometimes used in the literature without stating it
as an a numbered result (see for example \cite{AL15} Section 4.2).
