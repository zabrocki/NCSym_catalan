...
Properties of the category of \FGCCHAs (or its dual) have been considered in several references~\cite{AT22, Block85, FP24, MM65, Reutenauer-FreeLieAlgebras}.  
...
As a way of illustrating our results, we describe how they can be applied to resolve Problem~\ref{problem:motivating_calatan_question}.  
As stated above, the dimension sequence of $\NCSym$ is the Bell numbers,
\[
\vecdim(\NCSym) = (1, 2, 5, 15, 52, 203, 877, \ldots)
\qquad\text{see~\cite[\href{https://oeis.org/A000110}{A000110}]{OEIS}.}
\]
Every Hopf subalgebra of $\NCSym$ corresponds to a sequence whose inverse Euler transform is dominated by the inverse Euler transform of the Bell numbers, which is $(1, 3, 9, 34, 135, 610,\ldots)$~\cite[\href{https://oeis.org/A085686}{A085686}]{OEIS}.  
In particular, the Catalan numbers $(1, 2, 5, 14, 42, 132, 429, \ldots)$~\cite[\href{https://oeis.org/A000108}{A000108}]{OEIS} have inverse Euler transform $(1, 1, 3, 8, 25, 75, 245,\ldots)$~\cite[\href{https://oeis.org/A022553}{A022553}]{OEIS}, which is dominated by this sequence.  
...
%%%%%
\begin{example}
\lucas{Adapt into our story about $\mathsf{NCSym}$ as presented in here}
