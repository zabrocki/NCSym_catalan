...
We conclude the last last section with
Theorem~\ref{thm:subclassification2} which is a
procedure that uses the Eulerian idempotent for
constructing one of the many isomorphisms that we know must exist.
%\end{example}
