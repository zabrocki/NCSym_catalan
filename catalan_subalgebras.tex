...
At a more general level, properties of the category of \FGCCHAs (or its dual) have been considered in several references~\cite{AT22, Block85, FP24, LodayRonco10, MM65, Reutenauer-FreeLieAlgebras}, and the Milnor--Moore theorem states that the structure of an \FGCCHA $H$ is determined by the free Lie algebra of primitives in $H$.  
Experts in the field have related 
Many ``folklore results'' ....


%in the field make use of the Milnor--Moore theorem, which states that the structure of \FGCCHAs have been characterized by the number of free generators and the dimension of the subspace of primitives.  
