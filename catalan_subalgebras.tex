...
The Poincar\'{e}--Brikhoff--Witt Theorem~\cite[\S 0.1]{Reutenauer-FreeLieAlgebras}
...
\begin{example}\mike{TODO: discuss this one because $\phi_{a,p}(\vec{a}) = (2, 2, 4, 7, 16, \ldots)$}\lucas{you are right}
\label{ex:OPG}
...
Theorem~\ref{thm:a sequence}.\lucas{TODO: fold this into a remark after theorem 2.}
...
Aguiar and Sottile use the Eulerian Idempotent to produce primitive
generators in~\cite[Theorem 3.4]{aguiar2005cocommutative}, as do
Novelli and Thibon in~\cite[\S 5]{NT05}. We will prove this method holds for any \FGCCHA.
