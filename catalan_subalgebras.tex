...
Hopf algebra.  Building on known results (Theorem~\ref{thm:AT}, Proposition~\ref{prop:LieToFree}, Proposition~\ref{prop:indecomposable generators} Lemma~\ref{lemma:primitive generators}, and the Shirshov--Witt Theorem, Lemma~\ref{lem:ShiWitt}.), this perspective allows us determine 
