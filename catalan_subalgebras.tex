...
The following theorem states when there is a surjection from one Hopf algebra to another.
It also states that when there is a surjection that they can always be realized as a projection
of the primitive generators.
