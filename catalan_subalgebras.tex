...
\lucas{Explain how the next result fits into the literature.  I seem to remember it being a novel statement, and that e.g. Aguiar Mahajan actually don't seem to know that it holds in general?}
...
\begin{proposition}
\lucas{Convert this into a proof of Theorem~\ref{thm:OPGmaps} (i).  All that's needed is to link up the notation.}
...
\begin{remark}
\lucas{This is actually a proof of Theorem~\ref{thm:OPGmaps} (ii), should be converted as such.}
...
\lucas{We need to decide whether to keep these examples.  If we do, they should be edited up to the current notation/terminology and we need to find a home for them.}
...
\lucas{This section is almost empty!  Let's finish clearing it out and delete it.}
