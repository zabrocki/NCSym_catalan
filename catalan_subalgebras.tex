...
%One noteworthy property of this category is that it is closed under taking graded Hopf subalgebras.  
...
\]
We answer Problem~\ref{} by showing that all Hopf subalgebras of $\NCSym$ are \FGCCHAs.  In fact, this a consequence that \FGCCHAs are closed under taking graded Hopf subalgebras.  
...
%The remainder of Question (2a) is therefore asking whether there are Hopf subalgebras of $\mathsf{NCSym}$which are not \FGCCHAs
%
%
...
establishes conditions under which there exists a surjective
homomorphism from one \FGCCHA to another.
In the next section, Theorem~\ref{thm:subclassification2} states
conditions under which an \FGCCHA occurs as a Hopf subalgebra of
another; this classifies all Hopf subalgebras of \FGCCHAs.
