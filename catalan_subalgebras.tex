...
The Catalan numbers $\Catalan_{n} = \frac{1}{n+1}\binom{2n}{n}$ count several noteworthy classes of set partition, most notably the noncrossing and nonnesting partitions~\cite{}.\lucas{not sure what the best citation for this is - Stanley, OEIS, or something more bespoke?}  
