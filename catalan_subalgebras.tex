...
Using Aliniaefard and Thiem's result~\cite{}, $\mathbf{CQSym}$ and $\{\mathbf{p}_{\pi} \;|\; \text{$\pi$ is noncrossing}\}$ are isomorphic.  
...
Theorem~\ref{} outlines a procedure (using the Eulerian idempotent) for constructing one of the many isomorphisms that we know must exist.  
