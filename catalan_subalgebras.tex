...
The motivation for this paper came from a question that we originally tried to answer about the Hopf algebra of symmetric functions in noncommutative variables, $\NCSym$\lucas{``cite multiple papers''}.  
...
Inside the set of all partitions, the Catalan numbers enumerate several distinguished subsets including the nonnesting and noncrossing set partitions.  
We recognized that some of the bases had product and coproduct formulas which were closed if we restricted to the nonnesting or noncrossing subsets.  
