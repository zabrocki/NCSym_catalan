...
free non-commutative, co-commutative,
...
At a more general level, properties of the category of \FGCCHAs (or its dual) have been considered in several references~\cite{AT22, Block85, FP24, LodayRonco10, MM65, Reutenauer-FreeLieAlgebras}.  
Many folk-results in the field make use of the Milnor--Moore theorem, which states that the structure of \FGCCHAs have been characterized by the number of free generators and the dimension of the subspace of primitives.  

This paper builds on the Milnor--Moore framework to fully describe \FGCCHAs using as sequences of integers.  
Building on known results (Theorem~\ref{thm:AT}, Proposition~\ref{prop:LieToFree}, Proposition~\ref{prop:indecomposable generators}, Lemma~\ref{lemma:primitive generators}, and Proposition \ref{lem:ShiWitt}), this perspective allows us determine 
whether maps between \FGCCHAs exist by checking properties of the sequences.    
