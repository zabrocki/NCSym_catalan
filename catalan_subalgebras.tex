...
The category of \FGCCHAs (or its dual) has been studied generally by~\cite{MM65},~\cite{Block85},~\cite{Reutenauer-FreeLieAlgebras},~\cite{AT22},~\cite{FoissyPatras24}.  
Much work has been put into understanding specific examples including $\NCSym$~\cite{} as well as  \FGCCHAs of permutations~\cite{}, graphs~\cite{},.....
...
and for specific examples in~\cite{},~\cite{},~\cite{}, and~\cite{}, to give just a few of many examples.  
