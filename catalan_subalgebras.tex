...
\end{equation}\mike{I think that this is not a $\bigoplus$ if there is an intersection of these spaces, $\bigcup$ instead?}
...
\mike{do all of these references call it the `Eulerian idempotent'?  If not, take note here}
\[
...
generators for $\mathcal{H}_{HO}$ in~\cite[Theorem 3.4]{aguiar2005cocommutative}, as do
Novelli and Thibon for $\mathbf{CQSym}$ in~\cite[\S 5]{NT05}. Lauve and Mastnak use a related primitive idempotent to produce primitive generators for $\mathsf{NCSym}$ in~\cite[text]{LM11}. We will prove this method holds for any \FGCCHA.
\lucas{TODO: talk to Aaron Lauve next week about this.}
...
\end{lemma}
\eric{I found a paper which proves this exactly - Lemma 22 of Patras, Reutenauer - On Descent Algebras and Twisted Bialgebras https://reutenauer.math.uqam.ca/wp-content/uploads/2024/05/Twisted-bialgebras-compresse.pdf }
\begin{proof}
