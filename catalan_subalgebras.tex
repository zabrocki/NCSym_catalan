...
Let $\vec{a} = \phi_{h,a}(\vecdim(H))$ and $X_{\vec{a}}$ be the free generating set of $\mathcal{U}(\mathfrak{L}(\vec{a}))$.
...
\mike{I dont' know what Example Lucas was referring to here, it might have been cut or commented out}
