...
\mike{TODO: Read though this proof and make sure the $\vec{a}$'s and $\vec{h}$'s make sense.  Then delete this.}
...
Thus, by Aliniaeifard and Theim's result (Theorem~\ref{thm:AT})
