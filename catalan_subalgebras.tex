...
The paper~\cite{F12} deduces that free and cofree Hopf algebras are also determined by the sequences of
graded dimensions (Proposition 23).  
The present work builds a similar toolbox for the category of \FGCCHAs by collecting known results from the literature.
