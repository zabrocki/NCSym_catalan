...
\end{thm}
\begin{proof}
Let \(F(X)\) and \(\mathfrak{L}_{X}\) be the free algebra and free Lie algebra generated by X respectively and define the maps
\begin{align*}
    \begin{array}{rcl}
...
\begin{align*}
    ...
    \end{array} 
\end{align*} 
We claim that \(\tilde{\phi} \circ \tilde{\psi} = id\),
\begin{align*}
