...
This paper records and expands on the folklore in order to give a description of \FGCCHAs in terms of sequences of integers.\mike{for reference: Loday \cite{L08} might be useful}
