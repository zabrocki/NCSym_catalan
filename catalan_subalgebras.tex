...
\begin{enumerate}
\item Using Aliniaeifard--Thiem's result~\cite[Theorem 4.2]{AT22}, we only beed to compare the Hilbert series of $H$ and $\mathcal{U}\big(\mathfrak{L}(\vec{a})\big)$ to prove this part.  \lucas{Should we write out their proof to convince ourselves it is true.  It is short.}
