...
In particular, the Catalan numbers $(1, 2, 5, 14, 42, 132, \ldots)$~\cite[\href{https://oeis.org/A000108}{A000108}]{OEIS} have inverse Euler transform $(1, 1, 3, 8, 25, 75,\ldots)$~\cite[\href{https://oeis.org/A022553}{A022553}]{OEIS}, which is dominated by this sequence.  

Therefore $\NCSym$ has a Hopf subalgebra with Catalan dimension, which is unique up to isomorphism.  
As a concrete example, we identify one representative of this isomorphism class inside of $\NCSym$.  
