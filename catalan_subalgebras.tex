...
At a more general level, properties of the category of \FGCCHAs (or its dual) have been considered in several references~\cite{AT22, Block85, FP24, LodayRonco10, MM65, Reutenauer-FreeLieAlgebras}, and the Milnor--Moore theorem states that the structure of an \FGCCHA $H$ is determined by its free Lie algebra of primitives.  
Experts in the field have related 
Experts in the field will known that beyond this work, \FGCCHAs are completely determined by the number of free generators and the dimension of the subspace of primitives, but this result is not widely known or published.  

This paper records and expands on the folklore to fully describe \FGCCHAs using as sequences of integers.  
