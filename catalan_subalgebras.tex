...
We will also make use of the \emph{Eulerian Idempotent} (see \cite[Section 1.4]{AL15} )\lucas{TODO: Add original citation or reference (text) for eulerian idempotent.  First place to look: Aguiar--Lauve's ``Adams operator'' paper.  N.B.: Mike had identified a citation for this in the google chat.} \felix{The first one suggested seems to cover the subject}
\[
